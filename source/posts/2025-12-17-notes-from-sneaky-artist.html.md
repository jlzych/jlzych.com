---
title: Notes from Make (Sneaky) Art
...
_(This runs a little contrary to "building a curiosity spiral", which is more like "inside out", but I look at these as techniques to pull from as needed, not an either/or or dogma)_
...
1. **The head**: Draw a simple oval with one side flat-ish to indicate where they're looking
2. **Torso**: Draw a box! Make it angled to determine posture. Taper it, stretch it, skew it.
3. **Arms**: Use stacked rectangles with tapers. Try to capture what they're doing, holding, etc., to make them active and interesting.
4. **Legs**: Basically the bottom half of an uppercase "H". Or also some tapered rectangles. Also use these to capture movement and action.
5. **Details are simple shapes**: Ears are a "C". Eyes are dots. Nose is an "L". Mouth is a "C" on its' side, or a circle, half circle, etc.

![Sample sketch of drawing tiny people](/images/2025-sneaky-artist/tiny-people.jpeg)
